    ...
    <div className="min-h-screen bg-[#faf9f6]">
      ...
      <section className="relative pt-32 pb-20 px-6 min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              <span className="font-button text-xs font-bold tracking-widest uppercase text-[hsl(var(--marsala))]">
            ...
            <motion.p
              variants={fadeInUp}
              className="font-button text-base md:text-lg text-[hsl(var(--marsala))]/70 max-w-lg leading-relaxed"
            >
            ...
            >
              ...
              <Link href="/auth?tab=signup">
                <Button
                  className="font-button h-12 sm:h-14 w-full sm:w-auto px-6 sm:px-8 rounded-full bg-[hsl(var(--marsala))] hover:bg-[hsl(var(--cognac))] text-white text-base"
                >
                  Start Exchanging
                </Button>
              </Link>
              ...
              <Button
                variant="outline"
                className="font-button h-12 sm:h-14 px-6 sm:px-8 rounded-full border-[hsl(var(--cognac))] text-[hsl(var(--cognac))] text-base"
              >
                How it Works
              </Button>
            ...
            <TiltedCard
              ...
              overlayContent={
                <div className="bg-[hsl(var(--marsala))]/80 backdrop-blur-md px-5 py-2 rounded-full border border-white/20">
                  <p className="font-button text-white text-sm font-medium">
                    Learn • Teach • Grow
                  </p>
                </div>
              }
      ...
      <section className="py-24 px-6 bg-white">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="font-serif text-4xl md:text-5xl text-[hsl(var(--marsala))] mb-4">
              Mutual{" "}
              <span className="text-[#9A6451]">
                <em>Exchange</em>
              </span>
            </h2>

            <p className="font-button text-base md:text-lg text-[hsl(var(--cognac))] max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {[
              {
                icon: (
                  <BookOpen className="w-8 h-8 text-[hsl(var(--marsala))]" />
                ),
              ...
              {
                icon: (
                  <Search className="w-8 h-8 text-[hsl(var(--marsala))]" />
                ),
              ...
              {
                icon: (
                  <Users className="w-8 h-8 text-[hsl(var(--marsala))]" />
                ),
                title: "Grow Together",
              ...
              >
                ...
                {/* Card Title */}
                <h3 className="font-button text-2xl font-semibold text-[hsl(var(--marsala))] mb-3">
                  {card.title}
                </h3>

                {/* Card Description */}
                <p className="font-button text-base md:text-lg text-[hsl(var(--marsala))]/70 leading-relaxed">
                  {card.desc}
                </p>
      ...
      <section className="py-24 px-6 bg-[hsl(var(--rose-quartz))]/10 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto mb-16 flex justify-between items-end">
          ...
          <h2 className="font-serif text-4xl text-[hsl(var(--marsala))]">
            Explore{" "}
            <span className="text-[#9A6451]">
              <em>Skills</em>
            </span>
          ...
          <Link href="/explore">
            <span className="font-button text-base flex items-center gap-2 text-[hsl(var(--marsala))] hover:text-[hsl(var(--cognac))] cursor-pointer">
              View all categories →
            </span>
          </Link>
          ...
          <div className="flex gap-6 animate-marquee-left whitespace-nowrap mb-6">
            ...
            {[
              ...
              >
                ...
                <span className="font-button text-base font-medium text-[hsl(var(--marsala))]">
                  {skill}
                </span>
      ...
      <section className="py-32 px-6">
        ...
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          <p className="font-button text-base md:text-lg text-[hsl(var(--marsala))]/60 max-w-2xl mx-auto leading-relaxed">
          ...
          <Link href="/auth?tab=signup">
            <Button
              className="h-14 sm:h-16 px-6 sm:px-8 rounded-full bg-[hsl(var(--marsala))] hover:bg-[hsl(var(--marsala))] text-white font-button text-base sm:text-lg"
            >
              Join the Community
            </Button>
          </Link>
